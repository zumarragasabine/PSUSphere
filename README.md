...
<div>
  ...
  <section>
    ...
    <p>
      ...
      This project also introduces the process of setting up a Django application, creating models, managing data, and using tools like Git and Faker. 
      Overall, PSUSphere provides a simple and practical way to learn Django while building a functional student organization management system.
    </p>
  </section>
  <section>
    <table>
